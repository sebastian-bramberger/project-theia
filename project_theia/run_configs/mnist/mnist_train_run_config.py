...
def get_train_run_config():
    from project_theia.training.train_config import SingleModelTrainRun, TrainConfig
    from project_theia.data.data_config import MnistConfig, DataCommonConfig
    from project_theia.models_lightning.mnist.model_lightning_mnist import MnistClassifierConfig
    from project_theia.training.optimizer import OptimizerConfig
    ...
    model_config = MnistClassifierConfig(
